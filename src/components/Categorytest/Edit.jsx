...
import ITLIVELOGO from "../../assets/img/It live logO.png"
...
export default function Catigorytest_Edit() {
    ...
    function hedel_Edit(e) {
        e.preventDefault()
        axios.put(`https://it-test-backend.onrender.com/api/status-update/${id}`, {
            "name": text
        }).then(res => {
            // console.log(res);
            if (res.status === 200) {
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class=" d-flex justify-content-between align-items-center">
                                        ...
                                        <Link to="/Catigorytest_Index" class="btn btn-primary">Orqaga</Link>
                                    </div>
                                    <div class="card">
                                        <form action="">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input onChange={(e) => setText(e.target.value)} type="text" class="form-control" />
                                                </div>
                                                <div class="form-group">
                                                    <button onClick={hedel_Edit} type="submit" class="btn btn-success">Oz'gartirish</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
